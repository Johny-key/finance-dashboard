...
export default function StatCard({
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10">
          <div className="text-[10px] font-medium tracking-widest uppercase mb-3"
            style={{ color: 'rgba(255,170,148,0.85)', fontFamily: "'DM Mono', monospace" }}>
            {label}
          </div>
          <div className="text-[28px] xl:text-[32px] font-bold mb-2.5 leading-none shimmer-text"
  ...
  return (
    <div
      className="relative rounded-2xl p-5 overflow-hidden cursor-default inner-highlight group"
      style={{
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="text-2xl xl:text-3xl font-bold mb-2 leading-none"
          style={{ fontFamily: "'DM Mono', monospace", color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>
          {value}
        </div>
        {change && (
          <div className="flex items-center gap-1.5">
